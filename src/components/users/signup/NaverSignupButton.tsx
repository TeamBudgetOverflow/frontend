...
// import { noneTokenClient, userAPI } from '../../../apis/client';
...
const NaverSignupButton = () => {
  ...
  //   // localStorage.setItem('accessToken', response.request.responseURL.accessToken);
  //   window.location.href = `${response.request.responseURL.accessToken}`;
