  ...
  return (
    <HeaderLayout ref={ref}>
      ...
      <RightIcons>
        ...
        <Button
          show={showChatBtn && !showSearchBar}
          onClick={handleBugReport}
          onMouseOver={() => setShowBugTooltip(true)}
          onMouseLeave={() => setShowBugTooltip(false)}>
          <Icon
            width={showChatBtn && !showSearchBar ? 22 : 0}
            height={showChatBtn && !showSearchBar ? 24 : 0}
            color={'primary400'}
            path={
        ...
        <Button
          ...
          <Icon
            width={showChatBtn && !showSearchBar ? 24 : 0}
            height={showChatBtn && !showSearchBar ? 27 : 0}
            color={'primary400'}
            path={
